...
| [#79](https://github.com/Bobcatsfan33/Pharos/issues/79) | ~~Console: no CSP/headers, unauthenticated, demo-tenant~~ | Console | **Auth gate, per-user tenant scoping, and script-src nonce all done.** Residual: `style-src 'unsafe-inline'`, pending conversion of ~150 React inline style props to CSS classes |
