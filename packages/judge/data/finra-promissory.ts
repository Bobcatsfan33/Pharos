...
export const FINRA_PROMISSORY: LabeledExample[] = [
  ...
  {
    text: "Risk-free and guaranteed: your principal is protected and growth is certain.",
    label: 1,
  },
  ...
  {
    text: "Past performance does not guarantee future results; investments may lose value.",
    label: 0,
  },
  {
    text: "Thank you for your inquiry. Our team will follow up about your account shortly.",
    label: 0,
  },
  ...
  {
    text: "Please review the prospectus carefully before investing; risks are disclosed.",
    label: 0,
  },
  { text: "Your quarterly statement is attached. Contact us with any questions.", label: 0 },
  {
    text: "Markets fluctuate and the value of your portfolio can go down as well as up.",
    label: 0,
  },
